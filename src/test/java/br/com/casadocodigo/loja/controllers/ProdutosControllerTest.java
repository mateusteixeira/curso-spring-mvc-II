...
@ContextConfiguration(classes = {ProdutosController.class, JPAConfiguration.class, AppWebConfiguration.class, DataSourceConfigurationTest.class, SpringSecurityConfiguration.class})
@ActiveProfiles("test")
